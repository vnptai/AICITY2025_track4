...
data_root = '/media/hungdv/Source/Data/ai-city-challenge-2024/track4/val/'
metainfo = {
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + 'hand_label.json',
...
val_evaluator = dict(  # Validation evaluator config
    ...
    ann_file=data_root + 'hand_label.json',  # Annotation file path
