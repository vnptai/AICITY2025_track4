...
val_dataloader = dict(
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + 'train_syn.json',
...
val_evaluator = dict(  # Validation evaluator config
    ...
    ann_file=data_root + 'train_syn.json',  # Annotation file path
    ...
    outfile_prefix=data_root + 'train_syn_gen')  # 要保存的 JSON 文件的前缀
