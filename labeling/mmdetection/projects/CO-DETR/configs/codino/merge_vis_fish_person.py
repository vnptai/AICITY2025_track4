            ...
            [
                dict(
                    ...
                    scales=[(960, 2048),
                            ...
                            (1568, 2048), (1600, 2048), (1632, 2048),
                            (1664, 2048), (1696, 2048), (1728, 2048),
                            (1760, 2048), (1792, 2048), (1824, 2048)],
                    keep_ratio=True)
            ],
            [
                dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + 'train_merge_visdrone_fisheye_person.json',
        data_prefix=dict(img=data_root + 'train/images_vis_fish/')
    ))
...
val_dataloader = dict(
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + 'test_person.json',
...
val_evaluator = dict(  # Validation evaluator config
    ...
    ann_file=data_root + 'test_person.json',  # Annotation file path
