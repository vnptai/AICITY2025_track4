...
train_dataloader = dict(
    dataset=dict(
        ...
        ann_file='/media/hungdv/Source/Data/ai-city-challenge-2024/track4/Fisheye8K/ms_coco-format_labels/train.json',
        data_prefix=dict(img='/media/hungdv/Source/Data/ai-city-challenge-2024/track4/Fisheye8K/train/'),
