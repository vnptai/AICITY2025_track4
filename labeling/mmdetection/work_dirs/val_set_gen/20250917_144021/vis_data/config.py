...
test_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file=
        '/media/hungdv/Source/Data/AICity2025/track4_final/val/test.json',
        backend_args=None,
        data_prefix=dict(
            img='/media/hungdv/Source/Data/AICity2025/track4_final/val/images/'
        ),
        data_root='/media/hungdv/Source/Data/AICity2025/track4_final/val/',
        metainfo=dict(classes=(
            'Bus',
...
test_evaluator = dict(
    _scope_='mmdet',
    ann_file='/media/hungdv/Source/Data/AICity2025/track4_final/val/test.json',
    backend_args=None,
    format_only=True,
    metric=[
        'bbox',
    ...
    outfile_prefix=
    '/media/hungdv/Source/Data/AICity2025/track4_final/val/val_gen',
    type='CocoMetric')
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
work_dir = './work_dirs/val_set_gen'
