...
data_root = '../../data/visdrone_syn_enhance/'
metainfo = {
...
val_dataloader = dict(
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + 'visdrone_syn_enhance.json',
...
val_evaluator = dict(  # Validation evaluator config
    ...
    ann_file=data_root + 'visdrone_syn_enhance.json',  # Annotation file path
    ...
    outfile_prefix=data_root + 'visdrone_syn_enhance_gen')  # 要保存的 JSON 文件的前缀
