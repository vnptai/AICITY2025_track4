...
# Set up paths
COCO_FILE="labeling/data_processing/syn_labels/train_syn.json"
YOLO_OUTPUT_DIR="data/train/labels_syn"
IMAGE_DIR="data/train/images"
GT_DIR="data/train/labels"
FINAL_OUTPUT_DIR="data/train_syn"
