...
# Set up paths
COCO_FILE="labeling/data_processing/syn_labels/merged_syn.json"
YOLO_OUTPUT_DIR="data/merged_data/labels_syn"
IMAGE_DIR="data/merged_data/images"
GT_DIR="data/merged_data/labels"
FINAL_OUTPUT_DIR="data/merged_syn"
