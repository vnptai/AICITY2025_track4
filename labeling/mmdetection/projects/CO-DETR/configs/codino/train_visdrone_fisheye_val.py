        ...
        transforms=[
            ...
            [
                dict(
                    ...
                    scales=[(400, 1536), (500, 1536), (600, 1536)],
                    keep_ratio=True),
                dict(
                    type='RandomCrop',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + 'annotations_VisDrone_merge.json',
        data_prefix=dict(img=data_root + 'train_merge/images/')
    ))
...
val_dataloader = dict(
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file='/media/hungdv/Source/Data/ai-city-challenge-2024/track4/Fisheye8K/ms_coco-format_labels/test.json',
        data_prefix=dict(img='/media/hungdv/Source/Data/ai-city-challenge-2024/track4/Fisheye8K/test/images/')
        ))
test_dataloader = val_dataloader

val_evaluator = dict(  # Validation evaluator config
    type='CocoMetric',  # The coco metric used to evaluate AR, AP, and mAP for detection and instance segmentation
    ann_file='/media/hungdv/Source/Data/ai-city-challenge-2024/track4/Fisheye8K/ms_coco-format_labels/test.json',  # Annotation file path
