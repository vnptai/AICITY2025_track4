...
data_root = '/media/hungdv/Source/Data/ai-city-challenge-2024/track4/Fisheye8K_split/'
metainfo = {
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + 'ms_coco-format_labels/train.json',
...
val_dataloader = dict(
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + 'ms_coco-format_labels/test.json',
...
val_evaluator = dict(  # Validation evaluator config
    ...
    ann_file=data_root + 'ms_coco-format_labels/test.json',  # Annotation file path
    ...
    outfile_prefix='./work_dirs/test_split')  # 要保存的 JSON 文件的前缀
