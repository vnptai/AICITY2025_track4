...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + 'ms_coco-format_labels/train_other.json',
...
val_dataloader = dict(
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + 'ms_coco-format_labels/test_other.json',
...
val_evaluator = dict(  # Validation evaluator config
    ...
    ann_file=data_root + 'ms_coco-format_labels/test_other.json',  # Annotation file path
    ...
    outfile_prefix='./work_dirs/test_person')  # 要保存的 JSON 文件的前缀
